...
public class TestUtils {
  ...
  public static final CryptoAlgorithm KEY_COMMIT_CRYPTO_ALG =
   ...
   * <p>Usage: {@code
   *
   * <p><p><p><p>assertNullChecks( myAwsCrypto, "createDecryptingStream",
   * CryptoMaterialsManager.class, myCMM, InputStream.class, myIS ); }
   *
   * @param callee
   * @param methodName
   * @param args
