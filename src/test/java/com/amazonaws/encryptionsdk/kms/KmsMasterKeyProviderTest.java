...
public class KmsMasterKeyProviderTest {
  ...
  public static class ParameterizedDecryptTest {
    ...
    public static Collection<Object[]> testCases() {
      ...
      MKPTestConfiguration deprecated_oneCMK =
          new MKPTestConfiguration(null, null, Arrays.asList(KEY_ID_1));
      MKPTestConfiguration deprecated_twoCMKs =
          new MKPTestConfiguration(null, null, Arrays.asList(KEY_ID_1, KEY_ID_2));
