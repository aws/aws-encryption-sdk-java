...
public class DiscoveryDecryptionExample {
  ...
  static void encryptAndDecrypt(
      final String keyName, final String partition, final String accountId) {
    ...
    // 6. Instantiate an AWS KMS master key provider for decryption in discovery mode
    // (`buildDiscovery`) with a
    // Discovery Filter.
    //
    // In discovery mode, the AWS KMS master key provider attempts to decrypt only by using AWS KMS
    // ARNs
